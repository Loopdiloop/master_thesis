...
//        if(de_cal < 540)    // to exclude noise events, 106Cd exp.
  ...
  //      std::cout << id << std::endl;
...
#if defined(MAKE_CACTUS_TIME_ENERGY_PLOTS) && (MAKE_CACTUS_TIME_ENERGY_PLOTS>0) // GATE ON PEAKS FOR NAI TIME PLOTS
        ...
        } else if( na_t_c>215 && na_t_c<235 ) { // also tried a peak at longer delay, na_t_c>245 && na_t_c<265, file offline_186W_aa_rnpeak_twoafter_prompt.root, with more statistics

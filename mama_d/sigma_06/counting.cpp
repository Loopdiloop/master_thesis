{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,6.304500,50,4.730795,96371728.000000);
   ...
   float Bn[1]={5.871000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={3613000.000000};
   float rho_Bnerr[1]={130100.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    5.044,4.819e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.104500,660.259378,0.104500,115.858467,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,8415.086047,0.848500,1476.630249,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.576500,1917683.228613,3.576500,336503.875000,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.064500,41250213.373563,5.064500,7238347.000000,0.02,">");
   arrow4->Draw();
   c1->Update();

{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,6.304500,50,4.587798,132554120.000000);
   ...
   float Bn[1]={5.871000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={4487000.000000};
   float rho_Bnerr[1]={156000.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    5.044,6.628e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.104500,678.573679,0.104500,116.520248,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,9039.098169,0.848500,1552.135010,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.576500,2422063.220277,3.576500,415900.906250,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.064500,56911862.452340,5.064500,9772534.000000,0.02,">");
   arrow4->Draw();
   c1->Update();

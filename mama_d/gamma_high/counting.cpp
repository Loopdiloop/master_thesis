{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,6.304500,50,4.597368,143399088.000000);
   ...
   float Bn[1]={5.871000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={4649000.000000};
   float rho_Bnerr[1]={167400.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    5.044,7.170e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.104500,687.092004,0.104500,117.565247,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,9243.569787,0.848500,1581.625977,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.576500,2568350.907884,3.576500,439459.062500,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.064500,61555295.964453,5.064500,10532452.000000,0.02,">");
   arrow4->Draw();
   c1->Update();

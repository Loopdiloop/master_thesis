{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,6.304500,50,4.627508,145721680.000000);
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    5.044,7.286e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.104500,691.888914,0.104500,118.386024,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,9319.917267,0.848500,1594.689453,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.576500,2601637.016471,3.576500,445154.500000,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.064500,62511436.849318,5.064500,10696053.000000,0.02,">");
   arrow4->Draw();
   c1->Update();

{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,6.304500,50,4.614090,121949872.000000);
   ...
   float Bn[1]={5.871000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={4130000.000000};
   float rho_Bnerr[1]={148700.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    5.044,6.097e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.104500,668.907592,0.104500,115.816681,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,8817.791976,0.848500,1526.739136,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.576500,2274017.632389,3.576500,393730.281250,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.064500,52329039.776237,5.064500,9060408.000000,0.02,">");
   arrow4->Draw();
   c1->Update();

{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,6.304500,50,4.473596,183191824.000000);
   ...
   float Bn[1]={5.871000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={5688000.000000};
   float rho_Bnerr[1]={204800.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    5.044,9.160e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.104500,703.936797,0.104500,118.042313,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,9792.924475,0.848500,1642.163696,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.576500,3076744.797891,3.576500,515935.625000,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(5.064500,78851571.857891,5.064500,13222525.000000,0.02,">");
   arrow4->Draw();
   c1->Update();

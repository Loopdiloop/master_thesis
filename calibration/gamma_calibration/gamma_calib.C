...
// Cecilie, Aug 9, 2019
// Last update: edited by Marianne 2021
...
void fits_CACTUS_peaks_protongate(){
    ...
    // Grab input file
    TFile *file = TFile::Open("W186_a_p_gate_15N_19F.root");
    ...
    TH1D *px00 = banana_NaI00->ProjectionX("px00",155,175);
    ...
    TH1D *px01 = banana_NaI01->ProjectionX("px01",160,180);
    ...
    TH1D *px02 = banana_NaI02->ProjectionX("px02",160,185);
   ...
   // Make canvas to plot the 2D banana plots, nai_03, nai_05, nai_06 (nai_04 is empty)
    ...
    TH1D *px03 = banana_NaI03->ProjectionX("px03",200,230);//XX,228,250);
    ...
    TH1D *px05 = banana_NaI05->ProjectionX("px05",170,195);//XX,220);
    ...
    TH1D *px06 = banana_NaI06->ProjectionX("px06",165,190);//XX,210);
   ...
   // Make canvas to plot the 2D banana plots, nai_07, nai_10, nai_11 (nai_08 and nai_09 are empty)
    ...
    TH1D *px07 = banana_NaI07->ProjectionX("px07",170,195);//XX,220);
    ...
    TH1D *px10 = banana_NaI10->ProjectionX("px10",160,185);//XX,210);
    ...
    TH1D *px11 = banana_NaI11->ProjectionX("px11",170,195);//XX,220);
   ...
   // Make canvas to plot the 2D banana plots, nai_13, nai_14, nai_15 (nai_12 is empty)
    ...
    TH1D *px13 = banana_NaI13->ProjectionX("px13",170,193);//XX,220);
    ...
    TH1D *px14 = banana_NaI14->ProjectionX("px14",170,195);//XX,220);
    ...
    TH1D *px15 = banana_NaI15->ProjectionX("px15",170,200);//XX,225);
    ...
    TH1D *px16 = banana_NaI16->ProjectionX("px16",175,200);//XX,225);
    ...
    TH1D *px17 = banana_NaI17->ProjectionX("px17",165,190);//XX,215);
    ...
    TH1D *px18 = banana_NaI18->ProjectionX("px18",165,188);//XX,210);
    ...
    TH1D *px19 = banana_NaI19->ProjectionX("px19",170,200);//XX,220);
    ...
    TH1D *px20 = banana_NaI20->ProjectionX("px20",170,195);//XX,215);
    ...
    TH1D *px21 = banana_NaI21->ProjectionX("px21",170,195);//XX,220);
    ...
    TH1D *px22 = banana_NaI22->ProjectionX("px22",170,200);//XX,220);
    ...
    TH1D *px23 = banana_NaI23->ProjectionX("px23",170,200);//XX,225);
    ...
    TH1D *px24 = banana_NaI24->ProjectionX("px24",175,200);//XX,225);
    ...
    TH1D *px25 = banana_NaI25->ProjectionX("px25",170,195);//XX,220);
    ...
    TH1D *px26 = banana_NaI26->ProjectionX("px26",175,200);//XX,225);
    ...
    TH1D *px27 = banana_NaI27->ProjectionX("px27",170,195);//XX,220);
    ...
    TH1D *px28 = banana_NaI28->ProjectionX("px28",170,200);//XX,225);
    ...
    TH1D *px29 = banana_NaI29->ProjectionX("px29",175,200);//XX,220);

{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,7.792500,50,0.333893,143900000.000000);
   ...
   TArrow *arrow1 = new TArrow(0.352500,799.811143,0.352500,122.230995,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,2741.639518,0.848500,418.990570,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.328500,370836.100940,3.328500,56672.960938,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.320500,2347405.407992,4.320500,358741.812500,0.02,">");
   arrow4->Draw();
   c1->Update();

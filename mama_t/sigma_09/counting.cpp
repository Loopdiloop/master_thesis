{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,7.792500,50,0.329540,161300000.000000);
   ...
   float Bn[1]={7.360000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={16130000.000000};
   float rho_Bnerr[1]={1641000.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    6.234,8.065e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.352500,822.561484,0.352500,124.281067,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,2871.815220,0.848500,433.903442,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.328500,425750.085110,3.328500,64326.710938,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.320500,2795704.663136,4.320500,422403.875000,0.02,">");
   arrow4->Draw();
   c1->Update();

{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,7.792500,50,0.360564,109000000.000000);
   ...
   float Bn[1]={7.360000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={10900000.000000};
   float rho_Bnerr[1]={1110000.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    6.234,5.450e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.352500,780.830092,0.352500,122.691322,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,2557.995858,0.848500,401.936218,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.328500,275850.438495,3.328500,43344.199219,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.320500,1594852.358635,4.320500,250598.109375,0.02,">");
   arrow4->Draw();
   c1->Update();

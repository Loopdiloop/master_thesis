{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,7.792500,50,0.326184,160200000.000000);
   ...
   float Bn[1]={7.360000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={16020000.000000};
   float rho_Bnerr[1]={1815000.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    6.234,8.010e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.352500,812.630393,0.352500,122.864616,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,2835.602741,0.848500,428.725342,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.328500,419241.728763,3.328500,63386.718750,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.320500,2749978.541276,4.320500,415779.500000,0.02,">");
   arrow4->Draw();
   c1->Update();

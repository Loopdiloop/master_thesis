{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,7.792500,50,0.343091,126400000.000000);
   ...
   float Bn[1]={7.360000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={12640000.000000};
   float rho_Bnerr[1]={1287000.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    6.234,6.320e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.352500,785.258442,0.352500,121.573204,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,2639.495913,0.848500,408.645050,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.328500,323683.137988,3.328500,50112.414062,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.320500,1970140.279374,4.320500,305015.843750,0.02,">");
   arrow4->Draw();
   c1->Update();

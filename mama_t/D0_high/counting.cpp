{
   ...
   TH2F *h = new TH2F("h"," ",10,-0.887500,7.792500,50,0.337153,130600000.000000);
   ...
   float Bn[1]={7.360000};
   float Bnerr[1]={0.001};
   float rho_Bn[1]={13060000.000000};
   float rho_Bnerr[1]={1206000.000000};
   int i = 0;
   float a0 =  -0.8875;
   float a1 =   0.2480;
   float x,y,z;
   ...
   TLatex t;
   t.SetTextSize(0.05);
   t.DrawLatex(    6.234,6.530e+07,"^{xx}Yy");
   TArrow *arrow1 = new TArrow(0.352500,781.132664,0.352500,120.539810,0.02,">");
   arrow1->Draw();
   TArrow *arrow2 = new TArrow(0.848500,2640.512405,0.848500,407.468384,0.02,">");
   arrow2->Draw();
   TArrow *arrow3 = new TArrow(3.328500,333090.616417,3.328500,51400.589844,0.02,">");
   arrow3->Draw();
   TArrow *arrow4 = new TArrow(4.320500,2050452.575914,4.320500,316413.812500,0.02,">");
   arrow4->Draw();
   c1->Update();
